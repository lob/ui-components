...
There are 3 types of buttons: primary, secondary, and tertiary. By default, the button will display as primary.

There are 3 sizes of buttons: default, small, and large.

You can change the type and size of the button by adding the prop to the component.
