  ...
  <span :class="[{ 'cursor-not-allowed': disabled, 'cursor-pointer': !disabled }]">
    <component
      ...
      :class="[
        ...
        { 'secondary border border-[#5F83A5] text-[#416581] hover:bg-[#c5d6e626]': !disabled && secondary && !warning,
          'active:bg-[#c5d6e640] active:border-black active:text-black': !disabled && secondary && !warning },
