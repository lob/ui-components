  ...
  <span :class="[{ 'cursor-not-allowed': disabled, 'cursor-pointer': !disabled }]">
    <component
      ...
      :class=" [
        ...
        isLink ? `type-${size}-600`: '',
        isLink && bold ? `type-${size}-800 no-underline`: '',
        isLink ? 'text-blue-600 hover:text-blue-500' : 'flex justify-center items-center rounded-full',
        'focus:outline-dashed focus:outline-black focus:outline-offset-1 focus:ring-0 whitespace-nowrap',
