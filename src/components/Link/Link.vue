  ...
  <span :class="[{ 'cursor-not-allowed': disabled, 'cursor-pointer': !disabled }]">
    <component
      ...
      :class="[
        ...
        { 'px-0  focus-visible:ring-4 focus-visible:ring-offset-2 focus-visible:rounded-lg': link },
        { 'underline': underline && link },
        { '!text-gray-500': disabled && link },
        { 'text-base text-primary-500 hover:text-primary-900 active:text-primary-900': !inheritTextColor && link },
