...
There are (will be) 3 forms of megabuttons:
...
The format changes automatically based on which props you provide. Just give it a label, and it'll a mega text. Provide an imageSource and you get the image version. Give it text and it'll format itself appropriately.
