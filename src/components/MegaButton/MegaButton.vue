<template>
  <div>
    ...
    <label
      ...
      :class="[
        'h-full',
        'flex flex-column items-center rounded-lg my-5 mr-5 inline-block border-2 border-transparent ring-4 ring-transparent relative shadow-input cursor-pointer',
