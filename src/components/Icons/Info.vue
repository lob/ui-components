...
const sizeInfo = {
  ...
  m: { size: 16, path: 'M10.4 14.4H8.8V5.6a.8.8 0 0 0-.8-.8H6.667c-.442 0-.8.36-.8.8 0 .44.358.8.8.8H7.2v8H5.6c-.442 0-.8.36-.8.8 0 .44.358.8.8.8h4.8a.8.8 0 0 0 0-1.6zM8 3.2A1.6 1.6 0 1 0 8 0a1.6 1.6 0 0 0 0 3.2z' },
  s: { size: 14, path: 'M9.1 12.6H7.7V4.9a.7.7 0 0 0-.7-.7H5.833a.701.701 0 0 0 0 1.4H6.3v7H4.9a.701.701 0 0 0 0 1.4h4.2a.7.7 0 0 0 0-1.4zM7 2.8A1.4 1.4 0 1 0 7 0a1.4 1.4 0 0 0 0 2.8z' }
};
