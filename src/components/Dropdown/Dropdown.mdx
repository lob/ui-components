...
The listHeight prop is available if you wanted to set a fixed height on the dropdown list, and any overflow will be scrollable. The height passed in should include the units (i.e. '5rem', '5px').
